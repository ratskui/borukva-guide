...
export const sectionList: ISectionGroup[] = [
  {
    title: 'Додано',
    items: [
      { name: 'Нові рейки', image: '/borukva-guide/images/mechanics/general/turnout_rail.png', link: 'rails' },
      { name: 'Артефакти', image: '/borukva-guide/images/mechanics/general/bonaqua_axe.png', link: 'artefacts' },
      { name: 'Радіо', image: '/borukva-guide/images/mechanics/general/radio.png', link: 'radio', customClass: 'guide-img-fill' },
      { name: 'Полотно для малювання', image: '/borukva-guide/images/mechanics/general/canvas.png', link: 'polydecorations/canvas' },
      { name: 'Декілька видів дерев', image: '/borukva-guide/images/mechanics/general/lemon_sapling.png', link: 'new-plants' },
      { name: 'Меблі', image: '/borukva-guide/images/mechanics/general/bench.png', link: 'polydecorations/furniture' },
      { name: 'Куховарство', image: '/borukva-guide/images/mechanics/general/pickle_jar.png', link: 'food' },
    ]
  },
  {
    title: 'Змінено',
    items: [
      { name: 'Генерацію світу', image: '/borukva-guide/images/mechanics/general/screenshot.png', link: 'world-gen', customClass: 'guide-img-cover'},
      { name: 'Фермерство', image: '/borukva-guide/images/mechanics/general/harvest_sickle.png', link: 'farming' },
      { name: 'Вагонетки', image: '/borukva-guide/images/mechanics/general/minecart.webp', link: 'rails' },
      { name: 'Торгівлю з жителями', image: '/borukva-guide/images/mechanics/general/villager.webp', link: 'villagers' },
    ]
  }
]
